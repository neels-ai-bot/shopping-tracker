      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-sm overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">Set Price Alert</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div>
            ...
            <p className="font-medium text-gray-900 dark:text-gray-100">{productName}</p>
            {currentPrice && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-7 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-gray-100"
                placeholder="0.00"
                required
              />
            </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-slate-900"
            >
              {RETAILERS.map((r) => (
